...
export default class DepartmentInfo extends Component {
    ...
    onSubmitHandler = (e) => {
        ...
        axios.patch(`${BASE_URL}/departments/${_id}`, data)
            .then((response) => {
  ...
  render() {
   ...
   axios
      .get(`${BASE_URL}/admins/${department.addedBy}`)
      .then(res => {
          return res.data;
      })
      .then((response) => {
    ...
    return (
        <div className = "container">
                ...
                <div className = "form-group row">
                    ...
                    <div className = "col-sm-8">
                        <select 
                            ...
                            {
                                department.faculty == "" && (<option selected = {true} defaultValue = "">No value</option>)
                            }
                            {
                                faculties.map((faculty,index) => {
                                    if(faculty.faculty === department.faculty){
            ...
            {
                !this.props.readOnly && (<button id = {department._id} onClick = {this.onSubmitHandler} className = "btn btn-primary btn-block">Edit Data</button>)
            }
        </div>
    )
  }
