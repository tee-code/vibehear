...
export default function TableBodyForLecturerManageStudent({data,indexes,handleView}){
            ...
            return (
                <tr key = {index} name = {row._id}>
                    ...
                    <td className = "actions" key = {index+11}>
                        ...
                        <i onClick = {handleView} id = {JSON.stringify(row)} className = "icons fa fa-eye p-2">
